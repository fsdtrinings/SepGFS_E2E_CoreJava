...
public class EmployeeServiceImpl implements IEmployeeService {
	...
	@Override
	public List<Employee> getEmployeeByLocationAndDesignation(String des, String loc) {
		List<Employee> outputlist = empRepository.getEmployeeByLocationAndDesignation(des, loc);
		return outputlist;
	}
	...
	public List<Employee> getEmployeeByLocation(String location) {
		List<Employee> list = empRepository.getEmployeeByLocation(location);
		return list;
	}
